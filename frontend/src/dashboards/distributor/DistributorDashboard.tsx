...
import { getDistributorReport, type GeneratedReport } from "../../api/reportsApi";
...
export default function DistributorDashboard() {
  ...
  async function handleGenerateReport() {
    ...
    try {
      const res = await getDistributorReport(token);
    ...
    <AppShell navItems={NAV_ITEMS} pageLabel="Investors">
      ...
      <Card>
        <CardHeader
          title={
            <span className={styles.cardTitle}>
              <IconShield /> Portfolio report
            </span>
          }
          description="A summary of your investor book and allocations, generated by the AI Reporting Agent."
          actions={
