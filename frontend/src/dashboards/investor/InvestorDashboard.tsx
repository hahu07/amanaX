...
import { getInvestorReport, type GeneratedReport } from "../../api/reportsApi";
...
export default function InvestorDashboard() {
  ...
  async function handleGenerateReport() {
    ...
    try {
      const res = await getInvestorReport(token);
    ...
    <AppShell navItems={NAV_ITEMS} pageLabel="Notes">
      ...
      <Card>
        <CardHeader
          title={
            <span className={styles.cardTitle}>
              <IconShield /> Investor report
            </span>
          }
          description="A summary of your holdings and distributions, generated by the AI Reporting Agent."
          actions={
